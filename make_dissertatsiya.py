...
toc = [
    ...
    ("2.1. Kesish rejimlarini hisoblash (t, S, V)", 22, 1, False, False),
    ("2.2. Kesish kuchlari va kesish quvvatini hisoblash", 25, 1, False, False),
    ("2.3. Shpindel aylanish chastotasini aniqlash", 28, 1, False, False),
    ("2.4. Asosiy (mashina) va yordamchi vaqtni hisoblash", 30, 1, False, False),
    ("2.5. Asbob bardoshliligi va ishlov aniqligini hisoblash", 33, 1, False, False),

    ("III BOB. AVTOMATLASHTIRISH SXEMALARINI LOYIHALASH", 36, 0, True, False),
    ("3.1. Avtomatlashtirish darajasi va tamoyillari", 36, 1, False, False),
    ("3.2. Boshqaruv tizimi tarkibi (ChPU/CNC, PLK)", 38, 1, False, False),
    ("3.3. Datchiklar va o‘lchash-nazorat tizimlari", 41, 1, False, False),
    ("3.4. Yuritmalarni (servo, qadamli dvigatel) tanlash", 44, 1, False, False),
    ("3.5. Funksional va prinsipial sxemalarni ishlab chiqish", 47, 1, False, False),
    ("3.6. Boshqaruv dasturi algoritmi (G-kod) va modellashtirish", 50, 1, False, False),

    ("IV BOB. HAYOT FAOLIYATI XAVFSIZLIGI", 54, 0, True, False),
    ("4.1. Ish joyini tashkil etish va ergonomika", 54, 1, False, False),
    ("4.2. Elektr xavfsizligi", 56, 1, False, False),
    ("4.3. Mexanik xavfsizlik va himoya vositalari", 58, 1, False, False),
    ("4.4. Sanitariya-gigiyena sharoitlari (yoritish, shovqin, mikroiqlim)",
     60, 1, False, False),
    ("4.5. Yong‘in xavfsizligi va atrof-muhitni muhofaza qilish", 62, 1, False, False),

    ("V BOB. IQTISODIY SAMARADORLIK", 65, 0, True, False),
    ("5.1. Loyihaning kapital xarajatlarini hisoblash", 65, 1, False, False),
    ("5.2. Mahsulot tannarxini hisoblash", 67, 1, False, False),
    ("5.3. Avtomatlashtirishdan olinadigan iqtisodiy samara", 69, 1, False, False),
    ("5.4. Loyihaning o‘zini oqlash (qoplanish) muddati", 71, 1, False, False),
    ("5.5. Asosiy texnik-iqtisodiy ko‘rsatkichlar", 73, 1, False, False),

    ("XULOSA VA TAKLIFLAR", 75, 0, True, False),
    ("FOYDALANILGAN ADABIYOTLAR", 77, 0, True, False),
    ("ILOVALAR", 80, 0, True, False),
]
